            ...
            <div className="max-w-4xl mx-auto space-y-12">
              ...
              <div className="glass p-8 rounded-2xl">
                ...
                <div className="space-y-4">
                  {[
                    { time: '17:30', event: '開場' },
                    { time: '18:00', event: '開会式・オープニングパフォーマンス' },
                    { time: '18:30', event: '予選ラウンド開始' },
                    { time: '19:30', event: '休憩・オーディエンスタイム' },
                    { time: '20:00', event: '決勝ラウンド' },
                    { time: '21:00', event: '表彰式・クロージング' },
                    { time: '21:30', event: '終了' }
                  ].map((item, index) => (
                    <div key={index} className="flex items-center gap-4 p-4 rounded-lg bg-white/5 hover:bg-white/10 transition-all">
                      <div className="text-primary font-bold text-xl min-w-[80px]">{item.time}</div>
              ...
              <div className="glass p-8 rounded-2xl">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="p-6 rounded-xl bg-white/5">
                    <h3 className="text-xl font-bold mb-3 text-primary">フィジーク部門</h3>
                    <p className="text-gray-400 mb-4">美しい筋肉のバランスと全体的な美しさを競います</p>
                  ...
                  <div className="p-6 rounded-xl bg-white/5">
                    <h3 className="text-xl font-bold mb-3 text-primary">ボディビル部門</h3>
                    <p className="text-gray-400 mb-4">筋肉の大きさ、デフィニション、全体的な完成度を競います</p>
                    <ul className="space-y-2 text-gray-300">
                      <li className="flex items-center gap-2">
                        <span className="text-primary">•</span>
                        メンズボディビル
              ...
              <div className="glass p-8 rounded-2xl text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  <Link
                    href="/about"
                    className="inline-block glass hover:bg-white/10 border border-white/20 text-white font-bold py-4 px-12 rounded-full transition-all duration-300 transform hover:scale-105"
                  >
                    大会について詳しく見る
                  </Link>
                </div>
