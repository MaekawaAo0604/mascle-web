            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {events.map((event, index) => (
                <Link
                  ...
                  className="group relative rounded-2xl overflow-hidden transition-all duration-300 transform hover:-translate-y-2 hover:shadow-2xl block"
                  ...
                  <div className="relative h-[400px] overflow-hidden">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                      ...
                      <div className="mt-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        <div className="py-2 px-6 bg-primary hover:bg-primary-dark text-white rounded-full transition-all duration-300 font-medium inline-block">
                          詳細を見る →
                        </div>
                      </div>
                    </div>
